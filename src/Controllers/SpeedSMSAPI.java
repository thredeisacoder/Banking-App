...
public class SpeedSMSAPI {
	...
	public static final String mAccessToken="9WshocB-_ttByQsFw2Q3JBjgR6ZQaNvJ";
	public static final String sender ="30db6e1c951c6cbd";
	...
	* */
	public String sendSMS(String to, String content) throws IOException {
		String json = "{\"to\": [\"" + to + "\"], \"content\": \"" + EncodeNonAsciiCharacters(content) + "\", \"type\":" + 5 + ", \"brandname\":\"" + sender + "\"}";
